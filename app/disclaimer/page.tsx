    ...
    <PolicyLayout
      ...
      sections={[
        ...
        },
        {
          ...
          body: {
            en: 'Dream interpretations, astrology, Vastu, and spiritual content are based on traditional, cultural, and symbolic frameworks. These interpretations are subjective and for entertainment and self-reflection purposes only. They are not scientifically validated and should not be used as a basis for major life decisions. vedasach does not endorse any supernatural claims and presents this content as cultural knowledge, not as factual truth.',
            hi: 'स्वप्न व्याख्या, ज्योतिष, वास्तु और आध्यात्मिक सामग्री पारंपरिक, सांस्कृतिक और प्रतीकात्मक ढांचे पर आधारित हैं। ये व्याख्याएं व्यक्तिपरक हैं और केवल मनोरंजन और आत्म-चिंतन उद्देश्यों के लिए हैं। इन्हें वैज्ञानिक रूप से मान्यता प्राप्त नहीं है और इन्हें बड़े जीवन निर्णयों के आधार के रूप में उपयोग नहीं किया जाना चाहिए। vedasach किसी भी अलौकिक दावे का समर्थन नहीं करता और इस सामग्री को सांस्कृतिक ज्ञान के रूप में प्रस्तुत करता है, न कि तथ्यात्मक सत्य के रूप में।',
          },
        },
        {
        ...
        },
        {
          ...
          body: {
            en: 'You are solely responsible for how you use the information and products from vedasach. You agree to: conduct thorough research before acting on any information; consult qualified professionals for medical, legal, or financial matters; verify product suitability for your specific needs; follow all product instructions and warnings; and not hold vedasach liable for any consequences arising from your use of our content or products. By using this website, you acknowledge that you have read and understood this disclaimer.',
            hi: 'आप vedasach से प्राप्त जानकारी और उत्पादों का उपयोग करने के तरीके के लिए पूरी तरह से जिम्मेदार हैं। आप सहमत हैं: किसी भी जानकारी पर कार्रवाई करने से पहले पूरी तरह से शोध करने; चिकित्सा, कानूनी या वित्तीय मामलों के लिए योग्य पेशेवरों से परामर्श करने; अपनी विशिष्ट आवश्यकताओं के लिए उत्पाद उपयुक्तता सत्यापित करने; सभी उत्पाद निर्देशों और चेतावनियों का पालन करने; और हमारी सामग्री या उत्पादों के उपयोग से उत्पन्न किसी भी परिणाम के लिए vedasach को उत्तरदायी नहीं ठहराने के लिए। इस वेबसाइट का उपयोग करके, आप स्वीकार करते हैं कि आपने इस अस्वीकरण को पढ़ और समझ लिया है।',
          },
        },
        {
        ...
        },
        {
          ...
          body: {
            en: 'vedasach provides all content and services "as is" without any warranties, express or implied. We do not warrant that the website will be error-free, uninterrupted, secure, or that defects will be corrected. We make no warranties regarding the accuracy, reliability, or completeness of any content. Your use of the website is at your sole discretion and risk.',
            hi: 'vedasach सभी सामग्री और सेवाएं "जैसी हैं" बिना किसी वारंटी, व्यक्त या निहित प्रदान करता है। हम वारंटी नहीं करते कि वेबसाइट त्रुटि-मुक्त, निर्बाध, सुरक्षित होगी, या दोषों को सुधारा जाएगा। हम किसी भी सामग्री की सटीकता, विश्वसनीयता, या पूर्णता के बारे में कोई वारंटी नहीं देते। वेबसाइट का आपका उपयोग आपके विवेक और जोखिम पर है।',
          },
        },
      ]}
    />
