...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = a.meta_title || a.title || 'Legal Article – vedasach';
  const description = a.meta_description || a.excerpt || 'Latest legal news, updates, and analysis on vedasach.';
