...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = a.meta_title || a.title || 'Environment Article – vedasach';
  const description = a.meta_description || a.excerpt || 'Latest environment news, climate updates, and sustainability analysis on vedasach.';
