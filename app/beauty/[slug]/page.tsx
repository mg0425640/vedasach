...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = a.meta_title || a.title || 'Beauty & Skincare Article – vedasach';
  const description = a.meta_description || a.excerpt || 'Natural beauty tips, DIY skincare remedies, and holistic wellness guides on vedasach.';
