...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = a.meta_title || a.title || 'Business Article – vedasach';
  const description = a.meta_description || a.excerpt || 'Latest business news, market insights, startup stories, and economic analysis on vedasach.';
...
export default async function BusinessArticlePage({ params }: Props) {
  const { slug } = await params;
